...
<section class="flex flex-wrap flex-row-reverse h-full">
    <div class=" w-full lg:w-1/2 flex items-center justify-center bg-black h-96">
        <iframe src="https://www.google.com/maps/d/embed?mid=1sZ2z8IpbZLabA74uvQp_S-9tFVJZVYE&ehbc=000000" width="100%" height="100%"></iframe>
    </div>

     <div class=" w-full text-start lg:px-32 lg:w-1/2 flex flex-col gap-3 justify-center px-10 h-96">
        <h1 class=" font-extrabold text-3xl">Nuestras Sucursales</h1>
...
<section class="flex flex-wrap h-full">
    <div class=" w-full text-center lg:px-32 lg:w-1/2 flex flex-col gap-3 justify-center px-10 h-96 bg-black">
        <h1 class=" font-extrabold text-3xl text-white">Nuestras Marcas </h1>
    </div>
     ...
     <div class=" w-full text-start lg:px-32 lg:w-1/2 flex flex-col gap-3 justify-center px-10 h-96">
        <div class="w-full">
            <div class=" h-full grid text-center lg:grid-cols-3 grid-cols-2 gap-4 place-content-end">
                ...
                <img class=" justify-self-center object-cover w-24 py-10 sm:w-40" src="/assets/images/logos/dutygear.png" alt="">
                <img class=" justify-self-center object-cover w-24 py-10 sm:w-40" src="/assets/images/logos/firsttactical.png" alt="">
                <img class=" justify-self-center object-cover w-24 py-10 sm:w-40" src="/assets/images/logos/bates.png" alt="">
